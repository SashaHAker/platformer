...
class Ball(pg.sprite.Sprite):
    def __init__(self, player_rect, direction, all_sprites, map_pixel_width):
    ...
    def update(self):
        ...
        if self.rect.x >  self.map_pixel_width or self.rect.x < 0:
...
class Game:
        ...
        for event in pg.event.get():
            ...
            if event.type == pg.KEYDOWN:
                if event.key == pg.K_RETURN:
                    ball = Ball(self.player.rect, self.player.direction, self.all_sprites, self.map_pixel_width)
                    self.balls.add(ball)
    ...
    def draw(self):
        ...
        pg.draw.rect(self.screen, "red", (10, 10, self.player.hp * 10, 10))
        pg.draw.rect(self.screen, "black", (10, 10, 100, 10), 2)
